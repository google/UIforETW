...
PLATFORM_INTERFACE void ETWMarkWorkingSet(const char* pProcessName, const char* pProcess, float privateWS, float PSS, float workingSet);
...
inline void ETWMarkWorkingSet(const char* pProcessName, const char* pProcess, float privateWS, float PSS, float workingSet) {}
