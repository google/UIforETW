This directory contains xperf related scripts from a range of different blog posts.
I will try to mention where they come from in order to make it easy to get more
information.
...
Performance Toolkit, or WPT installed, As of Feb 2015 this is usually installed
from the Windows 8.1 Software Development Kit - newer versions should be
installed when they become available.

Some of these scripts rely on Microsoft DLLs or executables that come with
the Debuggers package, which also comes with the Windows SDK.
